...
> **RedNews:** on-demand only (the author advises against always-on) — run it as a review pass on finished landing/marketing pages and animations. PRODUCT.md and DESIGN.md in `app/` win over this skill's defaults; RedNews red stays the primary brand color.
